...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \frame {
    ...
    \todo{Batteries are likely past their healthy life. \blueite{something} will need to change.}
  }
  \frame{
    \frametitle{Main takeaway}
    \begin{itemize}
      ...
      \item<3 -> These batteries traded longevity for _ability to cycle_.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \frame{
    ...
    \begin{itemize}
      ...
      \item<3 -> A bank of 12 \bueite(lead calcium} batteries
